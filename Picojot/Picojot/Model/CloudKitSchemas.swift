...
let global_tempTags: [TempColorTag] = [
    ...
    TempColorTag(id: "black", name: "Other Long", colorRed: 0.25, colorGreen: 0.25, colorBlue: 0.25)
]
...
let global_tempJots: [TempJot] = [
    ...
    TempJot(title: "Interesting Quote", colorTagId: "green", bodyText: "You are what you absorb."),
